...
public final class GerritApiProvider {
    ...
    /**
     * @return the shared api for the configured Gerrit instance; it reads host and credentials from the live
     *         {@link GerritSettings}, so it stays valid after the user changes them
     */
